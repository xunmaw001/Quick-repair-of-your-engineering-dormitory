...
public class GuzhangshangbaoView extends GuzhangshangbaoEntity implements Serializable {
	...
	* 处理结果的值
	*/
	@ColumnInfo(comment="处理结果的字典表值",type="varchar(200)")
	private String guzhangshangbaoYesnoValue;
	...
	* 获取： 处理结果的值
	*/
	public String getGuzhangshangbaoYesnoValue() {
		return guzhangshangbaoYesnoValue;
	}
	/**
	* 设置： 处理结果的值
	*/
	public void setGuzhangshangbaoYesnoValue(String guzhangshangbaoYesnoValue) {
		this.guzhangshangbaoYesnoValue = guzhangshangbaoYesnoValue;
	}
	...
	public String toString() {
		return "GuzhangshangbaoView{" +
			", quyuValue=" + quyuValue +
			", guzhangshangbaoValue=" + guzhangshangbaoValue +
			", guzhangshangbaoYesnoValue=" + guzhangshangbaoYesnoValue +
