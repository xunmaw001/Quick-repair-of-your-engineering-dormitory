    ...
    */
    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(forum !=null){
            ...
            //级联表 维修人员
            //级联表
            WeixiuyuanEntity weixiuyuan = weixiuyuanService.selectById(forum.getWeixiuyuanId());
            if(weixiuyuan != null){
    ...
    */
    ...
    public R save(@RequestBody ForumEntity forum, HttpServletRequest request){
        ...
        if(false)
            ...
            forum.setWeixiuyuanId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
        ...
        Wrapper<ForumEntity> queryWrapper = new EntityWrapper<ForumEntity>()
            ...
            .eq("weixiuyuan_id", forum.getWeixiuyuanId())
...
//                            forumEntity.setWeixiuyuanId(Integer.valueOf(data.get(0)));   //维修人员 要改的
