    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="sessionTable !='weixiuyuan' ">
                    <el-form-item class="input" v-if="type!='info'"  label="维修人员姓名" prop="weixiuyuanName">
                        <el-input v-model="weixiuyuanForm.weixiuyuanName"
                                  placeholder="维修人员姓名" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="维修人员姓名" prop="weixiuyuanName">
                ...
                <el-col :span="12"  v-if="sessionTable !='weixiuyuan' ">
                    <el-form-item class="input" v-if="type!='info'"  label="维修人员手机号" prop="weixiuyuanPhone">
                        <el-input v-model="weixiuyuanForm.weixiuyuanPhone"
                                  placeholder="维修人员手机号" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="维修人员手机号" prop="weixiuyuanPhone">
                ...
                <el-col :span="12"  v-if="sessionTable !='weixiuyuan' ">
                    <el-form-item class="input" v-if="type!='info'"  label="维修人员身份证号" prop="weixiuyuanIdNumber">
                        <el-input v-model="weixiuyuanForm.weixiuyuanIdNumber"
                                  placeholder="维修人员身份证号" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="维修人员身份证号" prop="weixiuyuanIdNumber">
                ...
                <el-col :span="12" v-if="sessionTable !='weixiuyuan' ">
                    <el-form-item class="upload" v-if="type!='info' && !ro.weixiuyuanPhoto" label="维修人员头像" prop="weixiuyuanPhoto">
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.weixiuyuanPhoto" label="维修人员头像" prop="weixiuyuanPhoto">
                ...
                <el-col :span="12"  v-if="sessionTable !='weixiuyuan' ">
                    <el-form-item class="input" v-if="type!='info'"  label="维修人员邮箱" prop="weixiuyuanEmail">
                        <el-input v-model="weixiuyuanForm.weixiuyuanEmail"
                                  placeholder="维修人员邮箱" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="维修人员邮箱" prop="weixiuyuanEmail">
                            <el-input v-model="ruleForm.weixiuyuanEmail"
                                      placeholder="维修人员邮箱" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="报修编号" prop="guzhangshangbaoUuidNumber">
                       <el-input v-model="ruleForm.guzhangshangbaoUuidNumber"
                                 placeholder="报修编号" clearable  :readonly="ro.guzhangshangbaoUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="报修编号" prop="guzhangshangbaoUuidNumber">
                           <el-input v-model="ruleForm.guzhangshangbaoUuidNumber"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="详细地址" prop="guzhangshangbaoAddress">
                       <el-input v-model="ruleForm.guzhangshangbaoAddress"
                                 placeholder="详细地址" clearable  :readonly="ro.guzhangshangbaoAddress"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="详细地址" prop="guzhangshangbaoAddress">
                           <el-input v-model="ruleForm.guzhangshangbaoAddress"
            ...
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.guzhangshangbaoYesnoTypes" label="处理结果" prop="guzhangshangbaoYesnoTypes">
                        <el-input v-model="ruleForm.guzhangshangbaoYesnoValue" placeholder="处理结果" readonly></el-input>
                    </el-form-item>
                </div>
            </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.guzhangshangbaoYesnoText" label="处理回复" prop="guzhangshangbaoYesnoText">
                        <span v-html="ruleForm.guzhangshangbaoYesnoText"></span>
                    </el-form-item>
                </div>
            </el-col>
            </el-row>
    ...
    export default {
        ...
        created() {
            ...
            //获取下拉框信息
                ...
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=guzhangshangbao_yesno_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.guzhangshangbaoYesnoTypesOptions = data.data.list;
                    }
                });
