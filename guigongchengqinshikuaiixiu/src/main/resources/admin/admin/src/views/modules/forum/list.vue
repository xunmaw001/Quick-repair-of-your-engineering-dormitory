            ...
            <el-table :data="forumData" height="250">
                ...
                <el-table-column label="身份">
                    <template slot-scope="scope">
                        <span v-if="scope.row.weixiuyuanId">
                            维修人员
                        </span>
                ...
                <el-table-column property="caozuo" label="操作">
                    <template slot-scope="scope">
                        <el-button type="info"                          @click="seeForumContent(scope.row.forumContent)">回帖详情</el-button>
                            <el-button v-if="true &&( false|| (sessionTable == 'weixiuyuan' && scope.row.weixiuyuanId ==userId)
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/guigongchengqinshikuaiixiu/upload/forumMuBan.xls"
                        >批量导入论坛数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('forum','导入导出')"
                        ...
                        <template slot-scope="scope">
                            <span v-if="scope.row.weixiuyuanId">
                                <div v-if="scope.row.weixiuyuanPhoto">
                                    <img :src="$base.url+scope.row.weixiuyuanPhoto" width="100" height="100">
                                </div>
                                <div v-else>无图片</div>
                            </span>
                            <span v-if="scope.row.yonghuId">
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        data.data.list.forEach(el=>{
                            ...
                            forum.weixiuyuanId = el.weixiuyuanId;//---
                            forum.weixiuyuanName = el.weixiuyuanName;
                            forum.weixiuyuanPhone = el.weixiuyuanPhone;
                            forum.weixiuyuanIdNumber = el.weixiuyuanIdNumber;
                            forum.weixiuyuanPhoto = el.weixiuyuanPhoto;
                            forum.weixiuyuanEmail = el.weixiuyuanEmail;
                            forum.weixiuyuanDelete = el.weixiuyuanDelete;
