    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="评分" prop="weixiuyuanCommentbackPingfenNumber">
                       <el-input v-model="ruleForm.weixiuyuanCommentbackPingfenNumber"
                                 placeholder="评分" clearable  :readonly="ro.weixiuyuanCommentbackPingfenNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="评分" prop="weixiuyuanCommentbackPingfenNumber">
                           <el-input v-model="ruleForm.weixiuyuanCommentbackPingfenNumber"
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="评价内容" prop="weixiuyuanCommentbackText">
                        <el-input type="textarea"  :readonly="ro.weixiuyuanCommentbackText" v-model="ruleForm.weixiuyuanCommentbackText" placeholder="评价内容"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.weixiuyuanCommentbackText" label="评价内容" prop="weixiuyuanCommentbackText">
                            <span v-html="ruleForm.weixiuyuanCommentbackText"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
...
<script>
    ...
    export default {
        ...
        created() {
            ...
            if (this.role != "管理员"){
                this.ro.weixiuyuanId = true;//维修人员
                this.ro.yonghuId = true;//学生
                this.ro.weixiuyuanCommentbackText = true;//评价内容
                this.ro.weixiuyuanCommentbackPingfenNumber = true;//评价内容
            }
        ...
        methods: {
            ...
            info(id) {
                let _this =this;
                _this.$http({
                    url: `weixiuyuanCommentback/info/${id}`,
                    method: 'get'
                }).then(({ data }) => {
                    if (data && data.code === 0) {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`weixiuyuanCommentback/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.weixiuyuanCommentbackCrossAddOrUpdateFlag = false;
                                        this.parent.search();
