<template>
  <div>
    ...
    >  
     <el-row>
                    <el-col :span="12">
           <el-form-item v-if="flag=='weixiuyuan'"  label='维修人员姓名' prop="weixiuyuanName">
               <el-input v-model="ruleForm.weixiuyuanName"  placeholder='维修人员姓名' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
           <el-form-item v-if="flag=='weixiuyuan'"  label='维修人员手机号' prop="weixiuyuanPhone">
               <el-input v-model="ruleForm.weixiuyuanPhone"  placeholder='维修人员手机号' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
           <el-form-item v-if="flag=='weixiuyuan'"  label='维修人员身份证号' prop="weixiuyuanIdNumber">
               <el-input v-model="ruleForm.weixiuyuanIdNumber"  placeholder='维修人员身份证号' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
             <el-form-item v-if="flag=='weixiuyuan'" label='维修人员头像' prop="weixiuyuanPhoto">
                 <file-upload
                         tip="点击上传照片"
                         action="file/upload"
                         :limit="3"
         ...
         <el-col :span="12">
           <el-form-item v-if="flag=='weixiuyuan'"  label='维修人员邮箱' prop="weixiuyuanEmail">
               <el-input v-model="ruleForm.weixiuyuanEmail"  placeholder='维修人员邮箱' clearable></el-input>
           </el-form-item>
         </el-col>
...
|| flag=='weixiuyuan')"  label="性别" prop="sexTypes">
