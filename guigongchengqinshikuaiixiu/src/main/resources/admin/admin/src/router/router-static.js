...
import huanyuan from '@/views/modules/databaseBackup/huanyuan'
    ...
    import weixiuyuanCommentback from '@/views/modules/weixiuyuanCommentback/list'
    import yonghu from '@/views/modules/yonghu/list'
    import config from '@/views/modules/config/list'
    import dictionaryForumState from '@/views/modules/dictionaryForumState/list'
    import dictionaryGuzhangshangbao from '@/views/modules/dictionaryGuzhangshangbao/list'
    import dictionaryGuzhangshangbaoYesno from '@/views/modules/dictionaryGuzhangshangbaoYesno/list'
...
const routes = [{
    ...
    ,{
        path: '/dictionaryGuzhangshangbaoYesno',
        name: '处理结果',
        component: dictionaryGuzhangshangbaoYesno
    }
    ,{
        path: '/dictionaryNews',
        name: '公告类型',
    ...
    ,{
        path: '/weixiuyuanCommentback',
        name: '维修人员评价',
        component: weixiuyuanCommentback
      }
    ,{
        path: '/yonghu',
        name: '学生',
