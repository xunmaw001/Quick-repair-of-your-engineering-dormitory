<template>
	<view>
        ...
        <view class="username">
			<text v-if="forum.weixiuyuanId != null">
				 发布人：{{forum.weixiuyuanName}}（维修人员）
			</text>
			...
			<view class="uni-article__comment-box" v-for="comment in commentData" :key="comment.id" >
				<view class="article-meta">
					<view class="article-header-image">
                        <image v-if="comment.weixiuyuanId != null" class="image" :src="baseUrl+comment.weixiuyuanPhoto" mode="widthFix"></image>
					...
					<view class="article-header-content">
						<view class="article-header-title">
							<text v-if="comment.weixiuyuanId != null">{{comment.weixiuyuanName}}</text>
