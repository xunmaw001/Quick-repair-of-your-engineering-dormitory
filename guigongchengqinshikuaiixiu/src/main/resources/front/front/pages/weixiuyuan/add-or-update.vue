    ...
    <view class="content">
        <form class="app-update-pv">
            ...
            <view
                    ...
                    class="cu-form-group">
                <view :style='{"width":"160rpx","fontSize":"28rpx","color":"var(--publicMainColor)","textAlign":"left"}'
                      class="title">维修人员姓名</view>
                <input   disabled
                         :style='{"padding":"0 30rpx","boxShadow":"0 0 0px rgba(0,0,0,.6) inset","margin":"0","borderColor":"var(--publicMainColor)","backgroundColor":"#fff","color":"rgba(0, 0, 0, 1)","textAlign":"left","borderRadius":"0","borderWidth":"10rpx 2rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx"}'
                         :disabled="ro.weixiuyuanName" type="text" v-model="ruleForm.weixiuyuanName" placeholder="维修人员姓名"></input>
            </view>
            <view
                    :style='{"boxShadow":"0","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"rgba(228, 232, 230, 1)","margin":"0 0 0px 0","borderWidth":"2rpx","borderStyle":"none none solid none ","height":"100rpx"}'
                    class="cu-form-group">
                <view :style='{"width":"160rpx","fontSize":"28rpx","color":"var(--publicMainColor)","textAlign":"left"}'
                      class="title">维修人员手机号</view>
                <input   disabled
                         :style='{"padding":"0 30rpx","boxShadow":"0 0 0px rgba(0,0,0,.6) inset","margin":"0","borderColor":"var(--publicMainColor)","backgroundColor":"#fff","color":"rgba(0, 0, 0, 1)","textAlign":"left","borderRadius":"0","borderWidth":"10rpx 2rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx"}'
                         :disabled="ro.weixiuyuanPhone" type="text" v-model="ruleForm.weixiuyuanPhone" placeholder="维修人员手机号"></input>
            </view>
            <view
                    :style='{"boxShadow":"0","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"rgba(228, 232, 230, 1)","margin":"0 0 0px 0","borderWidth":"2rpx","borderStyle":"none none solid none ","height":"100rpx"}'
                    class="cu-form-group">
                <view :style='{"width":"160rpx","fontSize":"28rpx","color":"var(--publicMainColor)","textAlign":"left"}'
                      class="title">维修人员身份证号</view>
                <input   disabled
                         :style='{"padding":"0 30rpx","boxShadow":"0 0 0px rgba(0,0,0,.6) inset","margin":"0","borderColor":"var(--publicMainColor)","backgroundColor":"#fff","color":"rgba(0, 0, 0, 1)","textAlign":"left","borderRadius":"0","borderWidth":"10rpx 2rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx"}'
                         :disabled="ro.weixiuyuanIdNumber" type="text" v-model="ruleForm.weixiuyuanIdNumber" placeholder="维修人员身份证号"></input>
            </view>
                <view
                    ...
                    <view class="right-input" style="padding:0;textAlign:left">
                        <image
                                ...
                                class="avator" v-if="ruleForm.weixiuyuanPhoto" :src="baseUrl+ruleForm.weixiuyuanPhoto" mode="aspectFill">
                        </image>
            ...
            <view
                    ...
                    class="cu-form-group">
                <view :style='{"width":"160rpx","fontSize":"28rpx","color":"var(--publicMainColor)","textAlign":"left"}'
                      class="title">维修人员邮箱</view>
                <input   disabled
                         :style='{"padding":"0 30rpx","boxShadow":"0 0 0px rgba(0,0,0,.6) inset","margin":"0","borderColor":"var(--publicMainColor)","backgroundColor":"#fff","color":"rgba(0, 0, 0, 1)","textAlign":"left","borderRadius":"0","borderWidth":"10rpx 2rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx"}'
                         :disabled="ro.weixiuyuanEmail" type="text" v-model="ruleForm.weixiuyuanEmail" placeholder="维修人员邮箱"></input>
            </view>
        ...
        methods: {
            ...
            async onSubmitTap() {
				...
				if ((!this.ruleForm.weixiuyuanName)) {
                    this.$utils.msg(`维修人员姓名不能为空`);
                    return
                }
				if ((!this.ruleForm.weixiuyuanPhone) && (!this.$validate.isMobile(this.ruleForm.weixiuyuanPhone))) {
                    this.$utils.msg(`维修人员手机号不能为空并且需要输入正确格式`);
                    return
                }
				if ((!this.ruleForm.weixiuyuanIdNumber) && (!this.$validate.checkIdCard(this.ruleForm.weixiuyuanIdNumber))) {
                    this.$utils.msg(`维修人员身份证号不能为空并且需要输入正确格式`);
                    return
                }
				if ((!this.ruleForm.weixiuyuanPhoto)) {
                    this.$utils.msg(`维修人员头像不能为空`);
                    return
                }
				...
				if ((!this.ruleForm.weixiuyuanEmail) && (!this.$validate.isEmail(this.ruleForm.weixiuyuanEmail))) {
                    this.$utils.msg(`维修人员邮箱不能为空并且需要输入正确格式`);
                    return
                }
                if (this.ruleForm.id) {
