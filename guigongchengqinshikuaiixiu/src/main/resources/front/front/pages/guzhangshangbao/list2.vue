	...
	<view class="cu-bar bg-white search" :style="[{top:CustomBar + 'px'}]">
        ...
        <view class="action">
            ...
            <button
                    ...
                    v-if="isAuth('guzhangshangbao','新增')" @click="onAddTap()" class="uniui-add">新增</button>
		</view>
	</view>
	<view style="display: flex">
        <view style="padding: 0 20rpx;width: 100%;margin: 0 auto;;flex-direction: column;flex-wrap: wrap;flex-direction: row;margin-top: 0upx;">
            <view class="list b-b" v-for="(item, index) in list" :key="index" style="width:100%;height: auto;border: 1rps solid #999;margin: 0 auto;background-color: #FFFFFF;margin-top: 10rpx; box-shadow: 0  0 10rpx 0 #999999;border-radius: 25rpx;">
                <view
                 ...
                 <view v-show="item.guzhangshangbaoUuidNumber" style="display: flex;justify-content: space-between;align-items: center;margin-top: 15rpx;">
                     ...
                     <text style="width: 70%">{{item.guzhangshangbaoUuidNumber}}</text>
                 </view>
                 ...
                 <view v-show="item.guzhangshangbaoAddress" style="display: flex;justify-content: space-between;align-items: center;margin-top: 15rpx;">
                     ...
                     <text style="width: 70%">{{item.guzhangshangbaoAddress}}</text>
                 </view>
                 <view v-show="item.guzhangshangbaoGuzhang" style="display: flex;justify-content: space-between;align-items: center;margin-top: 15rpx;">
                     ...
                     <text style="width: 70%">{{item.guzhangshangbaoGuzhang}}</text>
                 </view>
                 ...
                 <view v-show="item.guzhangshangbaoYesnoText" style="display: flex;justify-content: space-between;align-items: center;margin-top: 15rpx;">
                     ...
                     <text style="width: 70%">{{item.guzhangshangbaoYesnoText}}</text>
                 </view>
            <view style="display: flex;justify-content: space-between;align-items: center;margin-top: 15rpx;font-size: 12rpx;color: #8799A3;">
                ...
                <uni-icons v-show="isAuth('guzhangshangbao','修改')" @tap="onUpdateTap(item.id)" type="compose" size="20">
                </uni-icons>
                ...
                <!--<view v-if="isAuth('guzhangshangbao','审核') && item.guzhangshangbaoYesnoTypes==1" class="" style="display: flex; width: 70%;color: #FFFFFF;">
...
<script>
	export default {
		...
		async onShow() {
            ...
            this.categoryList = guzhangshangbaoTypes.data.list

	   		//当前表的 处理结果 字段 字典表查询方法
		  	let guzhangshangbaoYesnoTypes = await this.$api.page('dictionary', {
			 	 page: 1,
			  	limit: 100,
		  		dicCode:'guzhangshangbao_yesno_types'
		  	});
		  	this.guzhangshangbaoYesnoTypesList = guzhangshangbaoYesnoTypes.data.list;
            ...
            wuyong(id) {
                ...
                uni.showModal({ content: '确定要 么?',title: '提示',
                    success: async function(res) {
                        if (res.confirm) {
                            await _this.$api.update(`guzhangshangbao`, {
                                id:id,
                            });
